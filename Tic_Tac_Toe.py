...
def get_unbeatable_ai_move(human, i):
    ...
    if i == 1: # i == tura
        if human == [1,1]:
            ...
            return [1,1]
    if i == 2: # i == tura
        if checkBestMove_ai() == None:
            if tablica[1][1] == 'O':
                if tablica[0][1]==tablica[1][2] !='.':
                    return [0,2]
                elif tablica[1][2]==tablica[2][1] !='.':
                    return [2,2]
                elif tablica[2][1]==tablica[1][0] !='.':
                    return [2,0]
                elif tablica[1][0]==tablica[0][1] !='.':
                    return [0,0]
                elif tablica[0][1]==tablica[2][1] !='.':
                    return [2,2]
                elif tablica[1][0]==tablica[1][2] !='.':
                    return [2,2]
                elif human == [0,2] or human == [1,2] or human == [2,2] and tablica[0][1] == '.':
                    return [0,1]
                elif human == [2,0] or human == [2,1] or human == [0,0] and tablica[1][0] == '.':
                    return [1,0]
...
def checkBestMove_ai():
    ...
    if tablica[0][0]==tablica[1][1] and tablica[2][2] == '.':
        return [2,2]
    elif tablica[1][1]==tablica[2][2] and tablica[0][0] == '.':
        return [0,0]
    elif tablica[0][2]==tablica[1][1] and tablica[2][0] == '.':
        return [2,0]
    elif tablica[1][1]==tablica[2][0] and tablica[0][2] == '.':
        return [0,2]
    elif tablica[0][0]==tablica[2][2] and tablica[1][1] == '.': #naprawione z np. X: A3,C1 i O: B2
        return [1,1]
    elif tablica[2][0]==tablica[0][2] and tablica[1][1] == '.':
        return [1,1]
    else:
        for row in range(0,3):
